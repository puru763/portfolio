...
<div className="about-container">
      ...
      <div className="about-data">
        <div className="intro">
          Hi Everyone, My name is  <span className="ah"> Purvesh Krishnani </span>  and I am from   <span className="ah"> Mumbai  </span> . I
          have completed my post graduation in   <span  className="ah">MSc (Computer Science )</span>  from KC
          Collge (Churchgate).
        </div>
